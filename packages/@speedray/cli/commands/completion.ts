...
const CompletionCommand = Command.extend({
  ...
  run: function (commandOptions: CompletionCommandOptions) {
    ...
    caseBlock = `sr|help) opts="${optsNg.sort().join(' ')}" ;;${caseBlock}
             *) opts="" ;;`;
    ...
    console.log(stripIndent`
      ...
      #
      # Usage: . <(sr completion --bash) # place it appropriately in .bashrc or
      #        . <(sr completion --zsh) # find a spot for it in .zshrc
      #`);
