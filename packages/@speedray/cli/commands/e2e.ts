...
const E2eCommand = Command.extend({
  ...
  availableOptions: overrideOptions([
    ...
    },
    {
      ...
      description: oneLine`
        ...
        Can send in multiple suite by comma separated values (sr e2e --suite=suiteA,suiteB).
      `
    },
    {
  ...
  run: function (commandOptions: E2eTaskOptions) {
    const E2eTask = require('@angular/cli/tasks/e2e').E2eTask;
    ...
    if (commandOptions.serve) {
      const ServeTask = require('@angular/cli/tasks/serve').default;
