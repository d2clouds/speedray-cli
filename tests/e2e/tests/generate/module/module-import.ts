...
export default function () {
  ...
  return Promise.resolve()
    ...
    .then(() => sr('generate', 'module', 'test5', '--module', 'sub'))
    ...
    .then(() => sr('generate', 'module', 'test6', '--module', join('sub', 'deep'))
    ...
    .then(() => sr('generate', 'module', 'test7', '--module', 'app.module.ts')))
    .then(() => expectFileToMatch(modulePath,
